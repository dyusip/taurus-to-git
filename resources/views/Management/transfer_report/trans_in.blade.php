    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Taurus Transfer In Report</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Taurus Transfer In Report</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/trans_in" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/trans_in/print">
