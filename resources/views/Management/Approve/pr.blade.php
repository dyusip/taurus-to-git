...
@section('index-content')
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Approve Purchase Request</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
    ...
    z-index: 9999; /* Specify a stack order in case you're using a different order for other elements */ padding: 23%; ">
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                <form method="post" name="myform" id="myform" action="/pr_approval">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-lg-7">
                ...
                success: function (output) {
                   ...
                   /* if ($.fn.dataTable.isDataTable('#dataTables-example')) {
                    ...
                    $.each(data.detail, function (index, value) {
                        $('tbody').append("<tr> " +
                            "<td><input type='text' class='form-control' readonly name='prd_prod_code[]' id='prd_prod_code' value='"+ value.prd_prod_code +"'></td> " +
                            "<td>"+ value.prd_prod_name +"</td> " +
                            "<td>"+ value.prd_prod_uom +"</td> " +
                            "<td><input type='text' class='form-control' name='prd_prod_qty[]' id='qty' value='"+ value.prd_prod_qty +"'></td> " +
                            "<td><input type='text' class='form-control' readonly name='prd_prod_price[]' id='cost' value='"+ value.prd_prod_price.toFixed(2) +"'></td> " +
                            "<td><input type='text' class='form-control amount' readonly name='prd_prod_amount[]' id='amount' value='"+ value.prd_prod_amount.toFixed(2) +"'></td> " +
                            "<td><a id='remove-row' class='text-danger' data-toggle='tooltip' title='Remove item'><i class='fa fa-remove'></i></a></td> " +
                            "</tr>");
                    });
                   // datatable();
