    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Taurus Sales Return Report</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Taurus Sales Return Report</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/salesreturn_report" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/salesreturn_report/print">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tbl-salesreport"
                                            ...
                                            <thead>
                                            <tr>
                                                <th width="11%">SR CODE</th>
                                                <th width="11%">SR DATE</th>
                                                <th data-hide="phone" width="11%">SO CODE</th>
                                                <th data-hide="phone" width="11%">SO DATE</th>
                                                <th data-hide="phone" width="12%">ITEM CODE</th>
                                                ...
                                                @foreach($sales as $sale)
                                                    @foreach($sale->sr_detail as $story)
                                                        <tr>
                                                            ...
                                                            <td>{{ $sale->sr_date }}</td>
                                                            <td>{{ $sale->so_code}}</td>
                                                            <td>{{ $sale->sr_so_header->so_date}}</td>
                                                            <td>{{ $story->srd_prod_code}}</td>
                                                            <td>{{ $story->srd_prod_name}}</td>
                                                            <td>{{ $story->srd_prod_qty}}</td>
                                                            <td>{{ $story->srd_prod_price}}</td>
                                                            <td>{{ $story->srd_less}}</td>
                                                            <td>{{ $story->srd_prod_amount}}</td>
                                                        </tr>
                                                        @php
