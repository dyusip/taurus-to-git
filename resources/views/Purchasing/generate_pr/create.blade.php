    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Taurus Generate Purchase Request</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Taurus Generate Purchase Request</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/gen_pr" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/gen_pr/print">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tbl-salesreport"
                                            ...
                                            <thead>
                                            <tr>
                                                <th data-hide="phone" width="9%">PR CODE</th>
                                            ...
                                            @if(isset($prs))
                                                ...
                                                @foreach($prs as $pr)
                                                    <tr>
                                                        <td>{{ $pr->prh_no }}</td>
                                                        <td>{{ $pr->pr_date }}</td>
                                                        <td>{{ $pr->prd_prod_code }}</td>
                                                        <td>{{ $pr->prd_prod_name }}</td>
                                                        <td>{!! Number_Format($pr->prd_prod_price,2) !!}</td>
                                                        <td>{{ $pr->prd_prod_qty }}</td>
                                                        <td>{!! Number_Format($pr->prd_amount,2) !!}</td>
                                                    </tr>
                                                    @php $total += $pr->prd_amount; @endphp
                                                @endforeach
                                            @endif
                                            </tbody>
                                            <tr>
