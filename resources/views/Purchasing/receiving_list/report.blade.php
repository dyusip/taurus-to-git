            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Taurus Receiving List</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/receiving_list" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tbl-salesreport"
                                            ...
                                            <thead>
                                            <tr>
                                                <th width="7%">REC CODE</th>
                                                <th data-hide="phone" width="7%">PO CODE</th>
                                                <th data-hide="phone" width="7%">SI #</th>
                                                <th data-hide="phone" width="18%">VENDOR</th>
                                                <th data-hide="phone" width="7%">REC DATE</th>
                                            ...
                                            @if(isset($items))
                                                ...
                                                @foreach($items as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->rh_po_no }}</td>
                                                            <td>{{ $item->rh_si_no }}</td>
                                                            <td>{{ $item->re_po_header->supplier->name }}</td>
                                                            <td>{{ $item->rh_date }}</td>
                                                            <td>{!! Number_Format($item->amount,2) !!}</td>
                                                            <td><a href="receiving_list/{{$item->rh_no}}" data-toggle="tooltip" target="_blank" title="Print" class="text-success" id="btn-edit" data-id='.$transfer->tf_code.'><i class="fa fa-print"></i></a></td>
                                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-left" colspan="2">{{ Number_Format(@$total,2) }}</th>
                                            </tr>
