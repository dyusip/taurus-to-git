    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Taurus Sales Logs Report</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Taurus Sales Logs Report</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/saleslogsreport" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/saleslogsreport/print">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tbl-salesreport"
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" width="9%">SI CODE</th>
                                                <th data-hide="phone" width="7%">DATE</th>
                                                ...
                                                @foreach($sales as $sale)
                                                    @foreach($sale->so_logs as $story)
                                                        <tr>
                                                            ...
                                                            <td>{{ $sale->jo_code }}</td>
                                                            <td>{{ $sale->so_date}}</td>
                                                            <td>{{ $story->sol_prod_code}}</td>
                                                            <td>{{ $story->sol_prod_name}}</td>
                                                            <td>{{ $story->sol_prod_qty}}</td>
                                                            <td>{{ $story->sol_prod_price}}</td>
                                                           {{-- <td>{{ $story->sod_less}}</td>--}}
                                                            <td>{{ $story->sol_prod_amount}}</td>
                                                            <td>{{ $story->sol_remarks}}</td>
                                                        </tr>
                                                        @php
