                    ...
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="form-inventory"  method="POST" action="/supplier">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                                <label>Email</label>
                                                <input type="text" autocomplete="off" placeholder="Email" value="{{ old('email') }}" name="email" id="email"  class="form-control">
                                                @if ($errors->has('email'))
                                                    <span class="help-block">
                                            ...
                                            <div>
                                                ...
                                                <button class="btn btn-sm btn-primary ladda-button ladda-button-demo btn-block" data-style="zoom-in" name="register" type="submit"><strong id="register">Create Supplier</strong></button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content animated fadeIn">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="status_name">Supplier Status</h4>
                                                <small >Activation and deactivation of supplier account</small>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','#btn-edit',function () {
            ...
            $.get(id+"/edit", function (data) {
                ...
                $('#form-inventory').attr('action','/supplier/'+data.id);
        ...
        $(document).on('click','#btn-delete',function () {
            var id = $(this).data('id');
            $('#form-status').attr('action','/supplier/'+id);
        });
