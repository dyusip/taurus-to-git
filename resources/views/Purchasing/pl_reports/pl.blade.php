            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Taurus Picklist Report</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/picklist" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/picklist/print">
                                            ...
                                            @if(isset($pls))
                                                ...
                                                @foreach($pls as $pl)
                                                    <tr>
                                                        ...
                                                        <td>{{ $pl->name }}</td>
                                                        <td>{{ $pl->req_date }}</td>
                                                        <td>{{ $pl->rqd_prod_code }}</td>
                                                        <td>{{ $pl->rqd_prod_name }}</td>
                                                        <td>{{ Number_Format($pl->rqd_prod_price,2) }}</td>
                                                        <td>{{ $pl->rqd_prod_qty }}</td>
                                                        <td>{{ Number_Format($pl->rqd_prod_srp,2) }}</td>
                                                        <td>{{ Number_Format($pl->rqd_amount,2) }}</td>
                                                    </tr>
                                                    @php
                                                        $total += $pl->rqd_amount;
                                                    @endphp
