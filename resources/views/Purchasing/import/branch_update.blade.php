    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Import Branch Inventory Update</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="/index">Home</a>
                        </li>
                        <li class="active">
                            <strong>Import Branch Inventory Update</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-7 b-r">
                                        ...
                                        @endif
                                        <form action="/import/branch_update" id="form-import" method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }}
