            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Miscellaneous In Report</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <form role="form" action="/miscellaneous_report" method="post" name="myform" id="myform">
                                ...
                                <div class="ibox-content tooltip-demo">
                                    <button data-toggle="tooltip" title="Print"  class="btn btn-primary btn-sm dim" name="CEOprintForm" formaction="/miscellaneous_report/print">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="tbl-salesreport"
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone,tablet" width="5%">COUNT SHEET</th>
                                                <th data-hide="phone,tablet" width="5%">PHYS COUNT</th>
                                                <th data-hide="phone,tablet" width="5%">VARIANCE (+)</th>
                                                <th data-hide="phone,tablet" width="8%">COST</th>
                                                <th data-hide="phone,tablet" width="8%">REMARKS</th>
                                            ...
                                            @if(isset($miscs))
                                                ...
                                                @foreach($miscs as $misc)
                                                    @php $count = $misc->msd_upd_qty - $misc->msd_prod_qty; @endphp
                                                    <tr>
                                                        <td>{{ $misc->msh_code }}</td>
                                                        <td>{{ $misc->msh_date }}</td>
                                                        <td>{{ $misc->msd_prod_code}}</td>
                                                        <td>{{ $misc->msd_prod_name}}</td>
                                                        <td>{{ $count }}</td>
                                                        <td>{{ $misc->msd_upd_qty}}</td>
                                                        <td>{{ $misc->msd_prod_qty}}</td>
                                                        <td>{!! Number_Format($misc->msd_prod_cost,2) !!}</td>
                                                        <td>{{ $misc->msd_remarks}}</td>
                                                        <td>{!! Number_Format($misc->msd_amount,2) !!}</td>
                                                    </tr>
                                                    @php
