                    ...
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form  method="POST" id="form-emp" action="/mechanic">
                                    {{--<input name="_method" type="hidden" disabled value="PUT" id="_method">--}}
                                    {{ csrf_field() }}
                                    <input type="hidden" name="position" value="MECHANIC">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        @foreach($mechanics as $mechanic)
                                            <tr>
                                                ...
                                                <td>{{ $mechanic->name }}</td>
                                                <td>{{ $mechanic->position }}</td>
                                                <td>{{ $mechanic->status }}</td>
                                                <td class="text-center">
                                                    <a href="javascript:;" class="text-success" id="btn-edit"  data-id="{{ $mechanic->id }}"><i class="fa fa-edit"></i></a>
                                                    <a href="#modal-emp-status" class="text-danger" id="btn-delete" data-id="{{ $mechanic->id }}" data-toggle="modal"><i class="fa fa-remove"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
...
<script>
    ...
    $(document).on('click','#btn-edit',function () {
        var id = $(this).data('id');
        $(".overlay").show();
        $.get("/mechanic/"+ id +"/edit", function (data) {
            $('.overlay').fadeOut();
            ...
            $('#form-emp').attr('action','/mechanic/'+data.id);
    ...
    $(document).on('click','#btn-delete',function () {
        var id = $(this).data('id');
        $('#form-status').attr('action','/mechanic/'+id);
    })
</script>
@endpush