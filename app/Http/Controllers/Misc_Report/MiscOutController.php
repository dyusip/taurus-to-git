...
class MiscOutController extends Controller
{
    //
    ...
    public function index()
    {
        ...
        return view($this->position().'.misc_report.misc_out',compact('branches'));
    }
    public function show(Request $request)
    {
        ...
        $branches = Branch::where(['status'=>'AC'])->get();
        return view($this->position().'.misc_report.misc_out',compact('miscs','request', 'branches'));
    }
    public function print_report(Request $request)
    {
        ...
        return Excel::create('Taurus Miscellaneous OUT Report', function ($excel) use ($data, $total, $br, $from, $to) {
            $excel->setTitle('Taurus Miscellaneous OUT Report');
            $excel->sheet('Miscellaneous OUT Report', function ($sheet) use ($data, $total, $br, $from, $to) {
                ...
                $sheet->prependRow(1, ["Taurus Miscellaneous OUT Report $br $from - $to"]);
