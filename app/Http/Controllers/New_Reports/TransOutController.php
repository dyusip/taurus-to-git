...
class TransOutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->position().'.transfer_report.trans_out',compact('branches'));
    }
    public function show(Request $request)
    {
        ...
        $branches = Branch::where(['status'=>'AC'])->get();
        return view($this->position().'.transfer_report.trans_out',compact('items','request', 'branches'));
    }
    public function print_report(Request $request)
    {
        ...
        return Excel::create('Taurus Transfer OUT Report', function($excel) use ($data, $total) {
            $excel->setTitle('Taurus Transfer OUT Report');
            $excel->sheet('Transfer OUT Report', function($sheet) use ($data, $total)
            {
                ...
                $sheet->prependRow(1, ["Taurus Transfer OUT Report "]);
