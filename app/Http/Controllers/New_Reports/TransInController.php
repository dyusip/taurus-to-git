...
class TransInController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->position().'.new_reports.trans_in',compact('branches'));
    }
    public function show(Request $request)
    {
        ...
        $branches = Branch::where(['status'=>'AC'])->get();
        return view($this->position().'.new_reports.trans_in',compact('items','request', 'branches'));
    }
    public function print_report(Request $request)
    {
        ...
        return Excel::create('Taurus Transfer IN Report', function($excel) use ($data, $total, $br, $from, $to) {
            $excel->setTitle('Taurus Transfer IN Report');
            $excel->sheet('Transfer IN Report', function($sheet) use ($data, $total, $br, $from, $to)
            {
                ...
                $sheet->prependRow(1, ["Taurus Transfer IN Report $br $from - $to"]);
